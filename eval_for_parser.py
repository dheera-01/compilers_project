...
if __name__ == "__main__":
    ...
    file = open("final_programs/Q2.krm", "r")
    file = open("final_programs/Q7.krm", "r")
    file = open("final_programs/Q11.krm", "r")
    # file = open("final_programs/Q12.krm", "r")
    # file = open("final_programs/Q17.krm", "r")
