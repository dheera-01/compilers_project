...
class Environment:
    ...
    def get(self, name):
     env_iter = iter(reversed(self.envs))
     return next((env[name] for env in env_iter if name in env), None)
    ...
    def update(self, name, value):
     env_iter = iter(reversed(self.envs))
     target_env = next((env for env in env_iter if name in env), None)
